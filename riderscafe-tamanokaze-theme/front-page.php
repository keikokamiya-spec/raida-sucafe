...
?>
  <main>
    ...
    <section id="hero" class="hero">
      <div class="hero-bg">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/hero-bg.jpg" alt="玉の風 ヒーロー背景" class="hero-bg-img">
        <div class="hero-overlay"></div>
      </div>
      <div class="hero-particles" id="hero-particles"></div>
      <div class="hero-content">
        <div class="hero-logo-wrap fade-in">
          <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/logo.jpg" alt="ライダースカフェ＆ダイナー 玉の風 ロゴ" class="hero-logo-img">
        </div>
      ...
      <div class="container">
        ...
        <div class="concept-story animate-on-scroll">
          <div class="concept-story-img">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/storefront.jpg" alt="玉の風 外観" loading="lazy">
          </div>
        ...
        <div class="menu-slider animate-on-scroll" id="menu-slider" aria-label="メニュースライドショー">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/karaage.jpg" alt="唐揚げランチ" loading="lazy">
            </div>
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/curry.jpg" alt="カレーランチ" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/hayashi.jpg" alt="ハヤシランチ" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/napolitan.jpg" alt="ナポリタンランチ" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/french-toast.jpg" alt="フレンチトースト" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/waffle.jpg" alt="ベルギーワッフル" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/yakiniku.jpg" alt="焼肉丼ランチ" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/saba.jpg" alt="さば or ホッケランチ" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/reimen.jpg" alt="盛岡冷麺" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/tuna-sand.jpg" alt="ツナサンド" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/pizza-sand.jpg" alt="ピザサンド" loading="lazy">
            </div>
            <div class="menu-card-body">
          ...
          <div class="menu-card">
            <div class="menu-card-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/menu/agepan.jpg" alt="揚げパン" loading="lazy">
            </div>
            <div class="menu-card-body">
        ...
        <div class="service-list">
          <div class="service-item animate-on-scroll">
            <div class="service-item-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/service/wash.jpg" alt="バイク専用洗車スペース" loading="lazy">
            </div>
          ...
          <div class="service-item service-item--reverse animate-on-scroll">
            <div class="service-item-img">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/service/chemical.jpg" alt="ケミカル用品販売" loading="lazy">
            </div>
            <div class="service-item-text">
          ...
          <div class="service-item animate-on-scroll">
            <div class="service-item-img service-item-img--maint service-item-img--no-crop">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/03.jpg" alt="工具無料貸出 & 簡易メンテ" loading="lazy">
            </div>
            <div class="service-item-text">
          ...
          <div class="service-item service-item--reverse animate-on-scroll">
            <div class="service-item-img service-item-img--fit">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/04.jpg" alt="ガラスコーティング" loading="lazy">
            </div>
            <div class="service-item-text">
          ...
          <div class="service-item animate-on-scroll">
            <div class="service-item-img service-item-img--maint service-item-img--contain">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/05_1.jpeg" alt="05のサービス 1" class="maint-img maint-img--1" loading="lazy">
              <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/05_2.jpeg" alt="05のサービス 2" class="maint-img maint-img--2" loading="lazy">
            </div>
            <div class="service-item-text">
          ...
          <div class="service-item service-item--reverse animate-on-scroll">
            ...
            <div class="service-item-text">
              ...
              <h3 class="service-item-title"><?php echo esc_html($service_title); ?></h3>
              <p class="service-item-desc"><?php echo nl2br(esc_html($service_text)); ?></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <?php foreach ($ride_events as $event) : ?>
            <div class="event-card animate-on-scroll">
              ...
              <div class="event-card-body">
                ...
                <p class="event-card-text"><?php echo nl2br(esc_html($event['text'])); ?></p>
              </div>
            </div>
          <?php endforeach; ?>
        </div>
          ...
          <div class="partner-shops-grid">
            <div class="partner-shop-card partner-shop-card--single partner-shop-card--tamanoya">
              ...
              <span class="partner-shop-sns">
                <a href="https://www.instagram.com/tamayama_junko?igsh=MXU4d2I1OWV1ZjZzYw%3D%3D" target="_blank" rel="noopener noreferrer"
                  class="partner-shop-icon" aria-label="居酒屋カラオケ玉の家 Instagram">
                  <i class="fab fa-instagram"></i>
                </a>
                <a href="https://www.facebook.com/people/%E7%8E%89%E5%B1%B1%E6%B7%B3%E5%AD%90/pfbid02vMv9cETtZuitdUz6MR5EL3qooTzwy1vMg7GuDURsZxyAeB5p1j9wuregycrcBt8cl/?mibextid=wwXIfr&rdid=Ecj8PAn80vf4yGu2&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F18QpBhmXwy%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer"
                  class="partner-shop-icon" aria-label="居酒屋カラオケ玉の家 Facebook">
            ...
            <div class="partner-shop-card partner-shop-card--single partner-shop-card--griff">
              ...
              <span class="partner-shop-sns">
                <a href="https://www.instagram.com/grifftire?igsh=MWxxZzl1MDV6YWk3MQ==" target="_blank" rel="noopener noreferrer"
                  class="partner-shop-icon" aria-label="タイヤショップグリフ Instagram">
                  <i class="fab fa-instagram"></i>
                </a>
                <a href="https://grifftire.jp/" target="_blank" rel="noopener noreferrer"
                  class="partner-shop-icon" aria-label="タイヤショップグリフ 公式HP">
    ...
    <section id="gallery" class="section section-gallery">
      <div class="container">
        ...
        <div class="gallery-slider animate-on-scroll" id="gallery-slider" aria-label="ギャラリースライドショー">
          ...
          <div class="gallery-item gallery-item--tall" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/preview (5).jpeg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/preview (5).jpeg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-01.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-01.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item gallery-item--tall" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-02.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-02.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-03.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-03.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-04.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-04.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item gallery-item--wide" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-05.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-05.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-06.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-06.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-07.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-07.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item gallery-item--tall" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-08.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-08.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-09.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-09.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-10.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-10.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item gallery-item--wide" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-11.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-11.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
          <div class="gallery-item" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-12.jpg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/gallery/gallery-12.jpg" alt="ギャラリー" loading="lazy">
            <div class="gallery-overlay"><i class="fas fa-expand"></i></div>
          </div>
            </div>
          </div>
            ...
            <div class="info-block">
              <h3 class="info-title info-title--hours">
                ...
                <span class="hours-sns">
                  <span>詳細はSNS</span>
                  <a href="https://www.instagram.com/riders_cafe_tamanokaze/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    <i class="fab fa-instagram"></i>
                  </a>
                  <a href="https://www.facebook.com/tamanokaze/?locale=ja_JP" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    <i class="fab fa-facebook-f"></i>
                  </a>
